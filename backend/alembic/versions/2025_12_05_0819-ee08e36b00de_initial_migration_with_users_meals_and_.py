"""Initial migration with users, meals, and sessions

Revision ID: ee08e36b00de
Revises: 
Create Date: 2025-12-05 08:19:26.402651
...
def upgrade() -> None:
    ...
    sa.Column('health_goal', sa.String(length=100), nullable=True),
